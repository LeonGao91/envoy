...
Network::FilterFactoryCb RedisProxyFilterConfigFactory::createFilterFactoryFromProtoTyped(
  ...
  std::cout << std::to_string(prefix_routes.routes_size()) << std::endl;
  std::cout << std::to_string(hash_slot_routes.routes_size()) << std::endl;
  ...
  std::cout << std::to_string(prefix_routes.routes_size()) << std::endl;
  std::cout << std::to_string(prefix_routes.catch_all_route().cluster().size()) << std::endl;
  std::cout << std::to_string(hash_slot_routes.routes_size()) << std::endl;
  std::cout << std::to_string(hash_slot_routes.catch_all_route().cluster().size()) << std::endl;
